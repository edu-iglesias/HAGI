...
@section('contents')
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href=""><span class="glyphicon glyphicon-list"></span> My Bids</a></li>
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<div class="text-muted">Awarded Projects</div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<div class="text-muted">New Opportunities</div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<div class="text-muted"> Passed Orders</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="dash/tables/data2.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
	...
	{{ HTML::script('dash/js/bootstrap-table.js') }}
	<script>
		!function ($) {
